...
from apps.ml.test_classifier.extra_trees import ExtraTreesClassifier
...
# from apps.ml.test_classifier.extra_trees import ExtraTreesClassifier # import ExtraTrees ML algorithm
